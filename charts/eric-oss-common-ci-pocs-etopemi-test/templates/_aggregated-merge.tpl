...
*/ -}}
{{- define "eric-oss-common-ci-pocs-etopemi-test.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-common-ci-pocs-etopemi-test.mergeAnnotations" -}}
  {{- include "eric-oss-common-ci-pocs-etopemi-test.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-common-ci-pocs-etopemi-test.mergeLabels" -}}
  {{- include "eric-oss-common-ci-pocs-etopemi-test.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
